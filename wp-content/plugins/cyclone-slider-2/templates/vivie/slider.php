...
<div tabindex="0" class="cycloneslider cycloneslider-template-standard cycloneslider-width-<?php echo esc_attr( $slider_settings['width_management'] ); ?>"
    ...
    >
    <div class="cycloneslider-slides cycle-slideshow" role="listbox"
        ...
        <?php foreach($slides as $slide): ?>
            <?php if ( 'image' == $slide['type'] ) : ?>
                <div class="banner_box cycloneslider-slide cycloneslider-slide-image" <?php echo $slide['slide_data_attributes']; ?>>
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            ...
                            <p class="hidden-xs"><?php echo wp_kses_post( $slide['description'] );?></p>

                            <br class="clear">

                            <a href="<?php echo esc_url( $slide['link'] );?>"  class="btn btn_banner">Learn More <span class="fa  fa-caret-right"></span></a>
